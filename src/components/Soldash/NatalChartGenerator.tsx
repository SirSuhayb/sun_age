  ...
  const generateChart = async () => {
    ...
    try {
      ...
      const horoscopeData = {
        ...
        month: birthDateTime.getMonth() + 1, // CircularNatalHoroscope expects 1-12
      ...
      const horoscope = new CircularNatalHoroscope(horoscopeData);
      
      // Get calculated positions
      const positions = horoscope.getPositions();
      const houses = horoscope.getHouses();
      const aspects = horoscope.getAspects();
