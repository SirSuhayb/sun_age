      ...
      <div className="w-full flex flex-col items-center">
        ...
        >
          <div className="px-6 pt-6 pb-2">
            {/* Header */}
            <div className="text-2xl font-serif font-normal text-black text-center mb-4" style={{ letterSpacing: '-0.04em' }}>{milestone.label}</div>
            <div className="flex flex-row items-end justify-between mb-2">
              {/* Milestone Number & Label */}
              <div>
                <div className="text-xl font-serif text-[#5F5F5F] font-normal mb-1" style={{ letterSpacing: '-0.02em' }}>{milestone.cycles.toLocaleString()} Solar Days</div>
              ...
              <div className="flex flex-col items-end">
                <div className="text-xl font-serif font-normal" style={{ color: '#AE8C25', letterSpacing: '-0.02em' }}>{milestone.daysToMilestone.toLocaleString()} days</div>
