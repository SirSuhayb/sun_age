      ...
      <div className="pt-0 pb-0 px-4 flex flex-col items-center justify-center relative w-full">
        ...
        <div className="flex items-center justify-between w-full max-w-md mx-auto mt-4 mb-2">
          ...
          <div className="flex flex-col items-start">
            ...
            <div className="text-base font-mono font-normal text-sm text-gray-600 mt-1 tracking-wider">
              {formattedDate}
            </div>
          </div>
          ...
          <div className="flex items-center gap-2">
            ...
            <button
              ...
              onClick={() => {
                ...
                if (saved) {
                  try {
                    ...
                    if (parsed.birthDate) {
                      window.location.href = `/surprise-me?birthDate=${parsed.birthDate}`;
                    } else {
              ...
              className="w-10 h-10 flex items-center justify-center border border-gray-300 bg-white shadow-sm hover:bg-purple-100 transition-colors"
              style={{ fontSize: 18, borderRadius: 0 }}
            >
              <span role="img" aria-label="Oracle">🔮</span>
            </button>
            
            {/* Solar Menu (🌞) */}
            <button
              onClick={handleSunClick}
              aria-label="Solar Token & Wallet"
