...
Users with 150M+ SOLAR tokens (~$63 value) get 1 year free access to the $77/year subscription - a holder discount! This bypasses Stripe entirely and redirects directly to the data collection page.